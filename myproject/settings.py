...
try:
    # python-dotenv provides load_dotenv; if not installed, silently skip
...
# DATABASE
try:
    # dj-database-url is an optional dependency in development; silence type checkers
...
if ENVIRONMENT == "production":
    if not dj_database_url:
        raise ImportError("dj_database_url is required in production. Install it with 'pip install dj-database-url'.")
